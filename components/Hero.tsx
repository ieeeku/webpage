...
export default function Hero() {
  return (
    ...
    >
      <CursorGrid />
      <div className="mx-auto max-w-6xl px-4 pb-14 pt-12 sm:px-6 md:px-10 md:pb-28 md:pt-24">
        <p className="font-mono text-label uppercase text-tertiary">
          # IEEE Kathmandu University Student Branch
        </p>

        <div className="mt-6 grid gap-10 md:grid-cols-[1.15fr_0.85fr] md:gap-10">
          <div>
            <h1 className="text-[2rem] leading-[1.08] text-primary sm:text-display-sm md:text-display">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:gap-4">
              <a
                href="/contact"
                className="w-full rounded-md bg-tertiary px-5 py-3 text-center font-mono text-label uppercase text-on-primary transition-opacity hover:opacity-90 sm:w-auto"
              >
                Apply for membership
              </a>
              <a
                href="/events"
                className="w-full rounded-md border border-secondary/40 px-5 py-3 text-center font-mono text-label uppercase text-primary transition-colors hover:border-tertiary hover:text-tertiary sm:w-auto"
              >
                View events
              </a>
            </div>
          ...
          <div className="self-start rounded-lg border border-secondary/25 bg-surface font-mono text-[0.76rem] shadow-[0_0_0_1px_rgba(0,0,0,0.2)] sm:text-[0.8rem]">
      ...
      <div className="border-t border-secondary/20 bg-neutral/60">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center gap-x-6 gap-y-3 px-4 py-6 sm:px-6 md:gap-x-10 md:px-10">
